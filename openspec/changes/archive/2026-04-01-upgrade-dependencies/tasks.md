...
- [x] 4.4 Commit: `chore(deps): upgrade ESLint to v10 and lint plugins`
...
- [x] 5.3 Run `pnpm dev` briefly to confirm HMR and dev server start correctly
...
- [x] 7.5 Manually verify all three routes (`/`, `/samples`, `/learner`) render correctly with `pnpm dev`
